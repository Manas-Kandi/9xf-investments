import type { Campaign, VCInfo } from '../types';

// Mock VC data
const mockVCs: Record<string, VCInfo> = {
  xyz: {
    id: 'vc1',
    name: 'XYZ Ventures',
...
export const mockCampaigns: Campaign[] = [
  {
    ...
    vc_info: mockVCs.xyz,
    vc_memo: 'SolarFlow represents the future of residential solar adoption. Their AI-first approach dramatically reduces customer acquisition costs while improving installation quality.',
    vc_reasons: [
    ...
    faqs: [
      {
        ...
        answer: 'You are investing in a SAFE (Simple Agreement for Future Equity) that converts to equity when SolarFlow raises a priced round or has a liquidity event.',
      },
      {
        question: 'How could I earn returns?',
        answer: 'If SolarFlow is acquired or goes public, your SAFE converts to shares which you can then sell. Returns depend on the company\'s valuation at that time.',
      },
      {
  ...
  },
  {
    ...
    vc_memo: 'The intersection of genomics and nutrition is a massive opportunity. MindfulMeals has cracked the code on personalization at scale.',
    vc_reasons: [
